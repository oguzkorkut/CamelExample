...
public class OrderBean {
     ...
     */
    public Map<String, Object> generateOrder(NewOrderRequest newOrderRequest) {
//    	Map<String, Object> answer = new HashMap<String, Object>();
//        answer.put("id", ran.nextInt(10000));
...
//        return answer;
        Map<String, Object> answer = new HashMap<String, Object>();
        answer.put("id", newOrderRequest.getId());
        answer.put("item", newOrderRequest.getItem());
        answer.put("amount", newOrderRequest.getAmount());
        answer.put("description", newOrderRequest.getDescription());
        return answer;
    }
